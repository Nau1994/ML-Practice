...
class LitNeuralNet(pl.LightningModule):
    ...
    def validation_step(self, batch, batch_idx):
        ...
        tensorboard_logs = {'avg_train_loss': loss}
    ...
    def on_validation_epoch_end(self):
        ...
        print(avg_loss.item())
        self.log("avg_loss", avg_loss, on_step=False, on_epoch=True, prog_bar=True)
        # use key 'log'
...
if __name__ == '__main__':
    ...
    trainer = Trainer(fast_dev_run=True,max_epochs=num_epochs)    
    trainer.fit(model)
